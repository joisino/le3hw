...
%token SEMI COMMA PLUS MINUS AND XOR OR LPAR RPAR LBRACE RBRACE LBRACK RBRACK LSHIFT RSHIFT LT LE GT GE EQEQ NEQ INT EQ IF ELSE WHILE FOR IN OUT RETURN CONTINUE BREAK
