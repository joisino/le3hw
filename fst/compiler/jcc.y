...
%token SEMI COMMA PLUS MINUS AND XOR OR LPAR RPAR LBRACE RBRACE LBRACK RBRACK LSHIFT RSHIFT LT LE GT GE EQEQ NEQ INT EQ IF ELSE WHILE IN OUT RETURN
%type <val> NTERM FUNCALL ARGS PRI MTERM PTERM STERM LGTERM EQEQTERM ATERM XTERM OTERM EXPR SARRAY SVAR RET WHILEB IFB STATEMENT STATEMENTS FUNC PARAM PARAMS GARRAY GVAR TOP PROGRAM
%%
